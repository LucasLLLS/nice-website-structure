...
define('IMG_PATH_VIEW', HOST.'/front/publicos/uploads' );
...
function loadImages() {
    ...
    if(file_exists($useruploadpath)){
        ...
        for($i=count($files)-1; $i >= 0; $i--):
            ...
            $image_name = $image_pathinfo['basename'];
            echo $image_name;
            ...
            if($file_style == "block") { ?>
                <div class="fileDiv"
                     onclick="showEditBar('<?php echo IMG_PATH_VIEW.$image_name; ?>','<?php echo $image_height; ?>','<?php echo $count; ?>', '<?php echo $image_name; ?>);"
                     ondblclick="showImage('<?php echo IMG_PATH_VIEW.$image_name; ?>','<?php echo $image_height; ?>');"
                     data-imgid="<?php echo $count; ?>">
                    <div class="imgDiv"><img class="fileImg lazy" data-original="<?php echo IMG_PATH_VIEW.$image_name; ?>"></div>
            ...
            <?php } elseif($file_style == "list") { ?>
                <div class="fullWidthFileDiv"
                     ...
                     ondblclick="showImage('<?php echo IMG_PATH_VIEW.$image_name; ?>','<?php echo $image_height; ?>');"
                     data-imgid="<?php echo $count; ?>">
                    <div class="fullWidthimgDiv"><img class="fullWidthfileImg lazy" data-original="<?php echo IMG_PATH_VIEW.$image_name; ?>"></div>
